...
public class StackSlot extends Register {
    ...
    public StackSlot(String name, Function parent, boolean isArgSlot) {
        super(name);
        this.parent = parent;
        if (!isArgSlot) parent.stackSlots.add(this);
    }

    public Function getFunc() { return parent; }

    public void _dump(Dump d) {d.println("stack slot");}
    public void accept(IRVisitor visitor) { visitor.visit(this);}
    public VirtualRegister copy() { return null; }
}